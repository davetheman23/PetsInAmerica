...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * maximum range possible, usually set by user
     */
    private int mMaxSlideRange = 9999;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child == mSlideableView) {
                ...
                mSlideRange = mSlideRange > mMaxSlideRange ? mMaxSlideRange : mSlideRange;
            }
    ...
    /**
     * set the limit to the sliding motion
     * @param maxRange in pixel, can use DisplayMetrics to obtain screen pixel
     */
    public void setMaxSlideRange(int maxRange){
    	mMaxSlideRange = maxRange;
    }
    
    public int getMaxSlideRange(){
    	return mMaxSlideRange;
    }
